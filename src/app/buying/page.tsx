        ...
        <Grid item xs={12} md={8}>
          ...
          <StyledPaper>
            ...
            <Typography paragraph>
              Our team will walk you through our step-by-step guide to get your house into selling shape, and you&apos;ll be well on your way to a successful sale!
            </Typography>
            <List>
              {[
          ...
          <StyledPaper>
            ...
            <Typography paragraph>
              Budgeting for a new home can be tricky. Not only are there mortgage installments and the down payment to consider, but there are a host of other—sometimes unexpected—expenses to add to the equation. Our team will guide you through the process to determine which costs will apply to your situation prior to structuring your budget.
            </Typography>
          ...
          <StyledPaper>
            ...
            <Typography paragraph>
              Once you&apos;ve been pre-qualified and know what price range you want to stay in, I can help you determine which properties fit your needs by using the (MLS) Multiple Listing Service system to locate them. I have the best possible resources and communication systems available today to help you locate the homes on the market that match your specifications.
            </Typography>
